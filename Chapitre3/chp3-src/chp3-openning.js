...
import { createAtmosphere } from './chp3-atmosphere.js';
...
function boot() {
    ...
    function init() {
        ...
        // Atmosphère (bokeh + rayons) : extraite dans chp3-atmosphere.js. Créée
        // ICI (tôt) car initDust/resizeDust/drawDust sont appelés plus bas
        // (démarrage, resize, drawAtmo) et une const ne bénéficie pas du hoisting.
        const atmo = createAtmosphere({ lightState, reduceMotion, lightDevice, mobileLite });
        const initDust = atmo.initDust, resizeDust = atmo.resizeDust, drawDust = atmo.drawDust;
        ...
        // ===============================================================
        //  ATMOSPHÈRE : bokeh + rayons — extraite dans chp3-atmosphere.js
        //  (la factory est créée en tête d'init(), cf. état atmosphère).
        // ===============================================================
