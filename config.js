...
/* ══════════════════════════════════════════════════════════════════
  ...
  COLLABORATION: {
    ...
    circles: {
      ...
      hover_titles: ['Les interpétations du geste de Soliman al-Halabi', 'L’héritage colonial du musée', 'Le Général Jean-Baptiste Kléber', 'Une histoire complexe', 'Le devenir du corps de Soliman al-Halabi (à venir)'],
      actions:      ['chapitre1', 'chapitre2', 'chapitre3', 'chapitre4', null],
    },
...
/* ══════════════════════════════════════════════════════════════════
  ...
  DOCUMENTS: {
    ...
    /* « À Propos » — mise en scène en deux temps (src/ui/AboutReveal.js).
       ...
       │      style: 'gold'    → mot-clef : s'écrit en blanc, s'embrase, se
       │                         dépose en doré. ITALIQUE par défaut : la main,
       │                         l'écriture, la personne (Soliman al-Halabi).
       │      engraved: true   → (avec 'gold') ROMAIN GRAS au lieu de l'italique :
       ...
       │                         plus dur — en banaliser l'usage le désamorce.
