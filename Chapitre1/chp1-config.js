...
export const CONFIG = {
  ...
  hotspots: [
    { img: 'himg-1', label: 'Langage',       l: 61, t: 40, w: 28, h: 35, media: 'Chapitre1/chp1-medias/S1.mp3',       credit: 'C & M., lycéenes' },
    { img: 'himg-2', label: '33',            l: 12, t: 41, w: 29, h: 37, media: 'Chapitre1/chp1-medias/C2.mp3',       credit: 'C., lycéene' },
    { img: 'himg-3', label: 'Éventualité',   l: 46, t:  0, w: 22, h: 22, media: 'Chapitre1/chp1-medias/S2.mp3',       credit: 'C., lycéene' },
    ...
    { img: 'himg-9', label: 'Nez',           l: 38, t: 62, w: 22, h: 22, media: 'Chapitre1/chp1-medias/S3.mp3',       credit: 'D., lycéen' },
  ],
};
